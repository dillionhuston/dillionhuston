...
**Backend Developer** based in **Belfast, UK**. Hi! I'm Dillon, I build APIs, automation tools, and useful systems that solve real problems. I'm also really into networking, system monitoring, and infrastructure.

[LinkedIn](https://www.linkedin.com/in/dillon-huston-412848288/) | [dev.to](https://dev.to/dillionhuston) 
...
### RouteReality
*Status: In Progress (Next to Polish)* [cite: 1]
...
* **Key Features:** FastAPI + JWT, Celery + Redis, Secure file storage, Docker Compose deployment, Email notifications, Webhook support .
* **Live Demo:** [dillonhtask.netlify.app](https://dillonhtask.netlify.app/) 
...
* **Tech Stack:** Flask backend + SQLAlchemy, Dart/Flutter frontend, Docker support .
...
File integrity checking utility supporting multiple hash algorithms .
